/* Overly long symbol name shared by the local entry point test.
...
#ifndef _TST_LOCALENTRY_NAME_H
#define _TST_LOCALENTRY_NAME_H 1
...
#define LOCALENTRY_SYMBOL CAT (tst_localentry_symbol_, N8192)
